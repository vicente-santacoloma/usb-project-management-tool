...
%><html:html>
    <head meta-id="Vp0KaV29LD3DAH7JxC5PGg==">
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="31"><html:link action="/A_PreConsultarPerfil.do"><bean:message key="V_GestionarUsuarios.label0"/><%-- Volver al perfil --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_GestionarUsuarios.label1"/><%-- Cerrar Sesi&oacute;n --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_GestionarUsuarios.label2"/><%-- Buscar --%></html:submit>
                </html:form></div>
