...
%><html:html>
    <head meta-id="i/z0Sfg0l2b0C8V0hgR75w==">
        <title><bean:message key="V_InvitarParticipanteProyecto.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_InvitarParticipanteProyecto.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_InvitarParticipanteProyecto.label1"/><%-- Cerrar Sesion --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_PreConsultarProyecto.do"><bean:message key="V_InvitarParticipanteProyecto.label2"/><%-- Consultar Proyecto --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_InvitarParticipanteProyecto.label0"/><%-- Buscar --%></html:submit>
                </html:form></div>
