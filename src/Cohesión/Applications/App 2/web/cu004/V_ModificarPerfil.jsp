...
%><html:html>
    <head meta-id="WFR2vlos7gpqds3rVnz+OA==">
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="31"><html:link action="/A_ModificarPerfil.do"><bean:message key="V_ModificarPerfil.label0"/><%-- Guardar cambios --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_ModificarPerfil.label2"/><%-- Cerrar Sesi&oacute;n --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_ModificarPerfil.label1"/><%-- Buscar --%></html:submit>
                </html:form></div>
