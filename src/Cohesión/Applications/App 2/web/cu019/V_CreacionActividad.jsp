...
%><html:html>
    <head meta-id="mvS8AT/HcLJ2nBDxoq2zSg==">
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="28"><html:link action="/A_PreCreacionActividad.do"><bean:message key="V_CreacionActividad.label1"/><%-- Creacion Actividad --%></html:link></cohesion:actor></li>
            ...
            <div id="body">
                ...
                <div class="box1969518"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_CreacionActividad.label0"/><%-- Crear Actividad --%></html:submit>
                    ...
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=V_CreacionActividad">Ayuda</a></li></ul></div>
