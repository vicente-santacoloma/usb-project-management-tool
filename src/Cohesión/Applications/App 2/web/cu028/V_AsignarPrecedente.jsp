...
%><html:html>
    <head meta-id="nuRkpP1Ert6zWbjAFMjt5g==">
        <title><bean:message key="V_AsignarPrecedente.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_AsignarPrecedente.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="4"><html:link action="/A_AsignarPrecedente.do"><bean:message key="V_AsignarPrecedente.label0"/><%-- Asignar Precedente --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_AsignarPrecedente.label1"/><%-- Cerrar Sesion --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_AsignarPrecedente.label2"/><%-- Busqueda --%></html:submit>
                </html:form></div>
