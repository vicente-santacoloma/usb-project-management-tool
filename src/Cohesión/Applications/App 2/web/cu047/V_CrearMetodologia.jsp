...
%><html:html>
    <head meta-id="4LGQVEqi7ZhRV/Q1vzEuIA==">
        <title><bean:message key="V_CrearMetodologia.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_CrearMetodologia.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_CrearMetodologia.label2"/><%-- Cerrar Sesion --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1970277"><html:form
                  action="/A_CrearMetodologia.do" method="post">
                  ...
                  <html:submit styleClass="button"><bean:message key="V_CrearMetodologia.label0"/><%-- A_CrearMetodologia --%></html:submit>
                </html:form></div>
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_CrearMetodologia.label1"/><%-- Busqueda --%></html:submit>
                </html:form></div>
