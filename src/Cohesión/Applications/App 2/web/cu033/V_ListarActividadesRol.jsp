...
%><html:html>
    <head meta-id="Nc343YFcDjU1jZX9Y0HNCw==">
        <title><bean:message key="V_ListarActividadesRol.title"/></title>
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="title"><bean:message key="V_ListarActividadesRol.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="28"><html:link action="/A_PreConsultaActividad.do"><bean:message key="V_ListarActividadesRol.label0"/><%-- Consulta Actividad --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="4"><html:link action="/A_PreListarRoles.do"><bean:message key="V_ListarActividadesRol.label1"/><%-- Listar Roles --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_ListarActividadesRol.label2"/><%-- Busqueda --%></html:submit>
                </html:form></div>

                         </div>
                    </div>
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=V_ListarActividadesRol">Ayuda</a></li></ul></div>
