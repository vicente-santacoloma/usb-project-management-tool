...
%><html:html>
    <head meta-id="r+brQANXNRQYHsnxSTUk4g==">
        <title><bean:message key="V_CambiarEdoMetodologia.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_CambiarEdoMetodologia.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="1"><html:link action="/A_CambiarEdoMetologia.do"><bean:message key="V_CambiarEdoMetodologia.label0"/><%-- A_CambiarEdoMetologia --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_CambiarEdoMetodologia.label2"/><%-- A_CerrarSesion --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_CambiarEdoMetodologia.label1"/><%-- A_PreBusqueda --%></html:submit>
                </html:form></div>
