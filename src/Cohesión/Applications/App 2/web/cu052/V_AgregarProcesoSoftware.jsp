...
%><html:html>
    <head meta-id="22xjBh7lzgaC56Oxdja53g==">
        <title><bean:message key="V_AgregarProcesoSoftware.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_AgregarProcesoSoftware.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_AgregarProcesoSoftware.label0"/><%-- A_CerrarSesion --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="2"><html:link action="/A_AgregarProcesoSoftware.do"><bean:message key="V_AgregarProcesoSoftware.label1"/><%-- A_AgregarProcesoSoftware --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_AgregarProcesoSoftware.label2"/><%-- A_PreBusqueda --%></html:submit>
                </html:form></div>
