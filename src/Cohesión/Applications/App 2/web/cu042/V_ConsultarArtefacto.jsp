...
%><html:html>
    <head meta-id="qjXhoO2kn4aqQ+trE7xpvw==">
        <title><bean:message key="V_ConsultarArtefacto.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_ConsultarArtefacto.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="4"><html:link action="/A_PreModificarArtefacto.do"><bean:message key="V_ConsultarArtefacto.label0"/><%-- A_Modificar Artefacto --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="12"><html:link action="/A_DescargarArtefacto.do"><bean:message key="V_ConsultarArtefacto.label2"/><%-- A_Descargar --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_ConsultarArtefacto.label1"/><%-- A_Busqueda --%></html:submit>
                </html:form></div>
