...
%><html:html>
    <head meta-id="uHvj0Xl+SOTilI6B+0iIYg==">
        <title><bean:message key="V_AsignarSucesora.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_AsignarSucesora.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="4"><html:link action="/A_AsignarSucesora.do"><bean:message key="V_AsignarSucesora.label0"/><%-- Asignar Sucesora --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_AsignarSucesora.label1"/><%-- Cerrar Sesion --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_AsignarSucesora.label2"/><%-- Busqueda --%></html:submit>
                </html:form></div>
