...
%><html:html>
    <head meta-id="9hMLuF8NOI/JNgkMgUIpjA==">
        <title><bean:message key="V_ActividadesPrecedentes.title"/></title>
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="title"><bean:message key="V_ActividadesPrecedentes.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="28"><html:link action="/A_PreConsultaActividad.do"><bean:message key="V_ActividadesPrecedentes.label0"/><%-- Consulta Actividad --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_ActividadesPrecedentes.label2"/><%-- Cerrar Sesion --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_ActividadesPrecedentes.label1"/><%-- Busqueda --%></html:submit>
                </html:form></div>

                         </div>
                    </div>
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=V_ActividadesPrecedentes">Ayuda</a></li></ul></div>
