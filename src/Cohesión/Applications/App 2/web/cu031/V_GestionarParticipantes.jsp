...
%><html:html>
    <head meta-id="4AVuI6H7pHkHyXM2JpP7sw==">
        <title><bean:message key="V_GestionarParticipantes.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_GestionarParticipantes.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="4"><html:link action="/A_PreAsignarRol.do"><bean:message key="V_GestionarParticipantes.label0"/><%-- Asignar Rol --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_GestionarParticipantes.label2"/><%-- Cerrar Sesion --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_GestionarParticipantes.label1"/><%-- Busqueda --%></html:submit>
                </html:form></div>
