...
%><html:html>
    <head meta-id="8sjFRofOd5LG8dXjpq+nJg==">
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_AgregarRolActividad.label2"/><%-- Cerrar Sesion --%></html:link></cohesion:actor></li>
...
<ul>
  ...
  <table border="1">
      <thead>
          <tr>
              <th><bean:message key="V_AgregarRolActividad.label0.1"/><%-- Nombre --%></th>
              <th><bean:message key="V_AgregarRolActividad.label0.2"/><%-- Descripcion --%></th>
              <th><bean:message key="V_AgregarRolActividad.label0.4"/><%-- Metodologia --%></th>
      ...
      <tbody>
          <logic:iterate id="rol" collection="${empty L_Rol ? _vacio : L_Rol}">
              <tr>
                  <td><html:link action="/A_AgregarRolActividad.do" paramId="idRol" paramName="rol" paramProperty="idRol">${empty rol.nombre ? "Editar" : rol.nombre}</html:link></td>
