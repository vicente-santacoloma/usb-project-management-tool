...
%><html:html>
    <head meta-id="vAAdx+PLosF5rb72OglBRA==">
        <title><bean:message key="V_ConsultarRol.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_ConsultarRol.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="2"><html:link action="/A_ConsultarRol.do"><bean:message key="V_ConsultarRol.label0"/><%-- A_ConsultarRol --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_ConsultarRol.label2"/><%-- A_CerrarSesion --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_ConsultarRol.label1"/><%-- A_PreBusqueda --%></html:submit>
                </html:form></div>
