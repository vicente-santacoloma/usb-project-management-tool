...
%><html:html>
    <head meta-id="vkfOt1HHqb2gNeAkexUIPQ==">
        <title><bean:message key="V_EliminarRol.title"/></title>
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="title"><bean:message key="V_EliminarRol.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="2"><html:link action="/A_EliminarRol.do"><bean:message key="V_EliminarRol.label0"/><%-- Eliminar --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_EliminarRol.label1"/><%-- Cerrar Sesion --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_EliminarRol.label2"/><%-- Busqueda --%></html:submit>
                </html:form></div>

                         </div>
                    </div>
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=V_EliminarRol">Ayuda</a></li></ul></div>
