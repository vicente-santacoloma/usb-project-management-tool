...
%><html:html>
    <head meta-id="yH2V3ZGT7BkewOlL0Tifcg==">
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="63"><html:link action="/A_PreIniciarSesion.do"><bean:message key="V_IniciarSesion.label1"/><%-- Reset --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_PreRecuperarContrasena.do"><bean:message key="V_IniciarSesion.label2"/><%-- Recuperar Contrase&ntilde;a --%></html:link></cohesion:actor></li>
