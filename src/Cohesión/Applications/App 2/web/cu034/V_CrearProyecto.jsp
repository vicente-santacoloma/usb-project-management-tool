...
%><html:html>
    <head meta-id="SijQrMbc8cBTABV9EjzsHg==">
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_CrearProyecto.label2"/><%-- Cerrar Sesion --%></html:link></cohesion:actor></li>
