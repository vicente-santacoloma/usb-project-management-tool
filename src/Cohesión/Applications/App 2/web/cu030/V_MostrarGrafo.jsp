...
%><html:html>
    <head meta-id="39LlWwr6MuuFiZVajfiqWQ==">
        <title><bean:message key="V_MostrarGrafo.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_MostrarGrafo.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="31"><html:link action="/A_PreConsultarProyecto.do"><bean:message key="V_MostrarGrafo.label0"/><%-- Consultar Proyecto --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_MostrarGrafo.label2"/><%-- Cerrar Sesion --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_MostrarGrafo.label1"/><%-- Busqueda --%></html:submit>
                </html:form></div>
