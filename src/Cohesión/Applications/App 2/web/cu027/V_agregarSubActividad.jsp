...
%><html:html>
    <head meta-id="rP7MjkbSwEoHDLVMc+WG+w==">
        <title><bean:message key="V_agregarSubActividad.title"/></title>
...
jQuery(function($) {
  ...
  $( "#1969525" ).datepicker();
            ...
            <div id="title"><bean:message key="V_agregarSubActividad.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_agregarSubActividad.label2"/><%-- Cerrar Sesion --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1969518"><html:form
                  action="/A_agregarSubActividad.do" method="post">
                  ...
                  <html:submit styleClass="button"><bean:message key="V_agregarSubActividad.label0"/><%-- A_agregarSubActividad --%></html:submit>
                </html:form></div>
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_agregarSubActividad.label1"/><%-- Busqueda --%></html:submit>
                </html:form></div>
