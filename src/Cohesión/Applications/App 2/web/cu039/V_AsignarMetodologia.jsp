...
%><html:html>
    <head meta-id="tCSKfCfQuCLkbgovrIU6EQ==">
        <title><bean:message key="V_AsignarMetodologia.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_AsignarMetodologia.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/A_AsignarMetodologia.do"><bean:message key="V_AsignarMetodologia.label0"/><%-- A_AsignarMetodologia --%></html:link></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_AsignarMetodologia.label2"/><%-- A_CerrarSesion --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_AsignarMetodologia.label1"/><%-- A_PreBusqueda --%></html:submit>
                </html:form></div>
