...
%><html:html>
    <head meta-id="YpRbJE3RUQxsmxo6KqUDPg==">
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="4"><html:link action="/A_AsignarRol.do"><bean:message key="V_AsignarRol.label0"/><%-- A_AsignarRol --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_AsignarRol.label2"/><%-- A_CerrarSesion --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_AsignarRol.label1"/><%-- A_Busqueda --%></html:submit>
                </html:form></div>
