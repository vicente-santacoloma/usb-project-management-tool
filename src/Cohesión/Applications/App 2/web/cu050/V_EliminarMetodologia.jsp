...
%><html:html>
    <head meta-id="LFNK5sagKsuB+00HiULmXg==">
        <title><bean:message key="V_EliminarMetodologia.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_EliminarMetodologia.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="2"><html:link action="/A_EliminarMetodologia.do"><bean:message key="V_EliminarMetodologia.label0"/><%-- A_EliminarMetodologia --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_EliminarMetodologia.label1"/><%-- A_CerrarSesion --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_EliminarMetodologia.label2"/><%-- A_PreBusqueda --%></html:submit>
                </html:form></div>
