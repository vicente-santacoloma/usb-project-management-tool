...
%><html:html>
    <head meta-id="XszG6mc5X0hl541rRTVg9A==">
        <title><bean:message key="V_EliminarProcesoSoftware.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_EliminarProcesoSoftware.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="31"><html:link action="/A_CerrarSesion.do"><bean:message key="V_EliminarProcesoSoftware.label1"/><%-- A_CerrarSesion --%></html:link></cohesion:actor></li>
                    <li><html:link action="/A_EliminarProcesoSoftware.do"><bean:message key="V_EliminarProcesoSoftware.label2"/><%-- A_EliminarProcesoSoftware --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_EliminarProcesoSoftware.label0"/><%-- A_PreBusqueda --%></html:submit>
                </html:form></div>
