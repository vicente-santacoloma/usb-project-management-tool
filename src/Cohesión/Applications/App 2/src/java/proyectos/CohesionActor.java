...
public class CohesionActor {
    ...
    public static final int ACTOR_administrador = 1;
    public static final int ACTOR_lider_de_metodologia = 2;
    public static final int ACTOR_lider_de_proyecto = 4;
    public static final int ACTOR_participante = 8;
    public static final int ACTOR_usuario = 16;
    public static final int ACTOR_visitante = 32;


    public static final String SALIDA_ACTOR = "A_AsignarMetodologia";
