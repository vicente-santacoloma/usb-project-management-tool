...
public class FActividad extends org.apache.struts.action.ActionForm {
    ...
    public static FActividad clear(ActionMapping mapping, HttpServletRequest request) {
        HttpSession sess = request.getSession();
        FActividad fFActividad = (FActividad) sess.getAttribute("FActividad");
        if (fFActividad == null) {
            fFActividad = new FActividad();
            sess.setAttribute("FActividad", fFActividad);
        } else {
            fFActividad.reset(mapping, request);
        }
        return fFActividad;
    }
