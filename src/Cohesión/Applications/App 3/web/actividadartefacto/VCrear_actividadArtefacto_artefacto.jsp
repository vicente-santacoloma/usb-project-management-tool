...
%><html:html>
    <head>
        <title><bean:message key="VCrear_actividadArtefacto_artefacto.title"/></title>
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="title"><bean:message key="VCrear_actividadArtefacto_artefacto.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/APre_artefacto.do" paramId="idArtefacto" paramName="idArtefacto"><bean:message key="VCrear_actividadArtefacto_artefacto.label1"/><%-- Artefacto --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1969668"><html:form
                  action="/ACrear_actividadArtefacto.do" method="post">
                  ...
                  <html:submit styleClass="button"><bean:message key="VCrear_actividadArtefacto_artefacto.label0"/><%-- Crear --%></html:submit>
                </html:form></div>

                         </div>
                    </div>
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=VCrear_actividadArtefacto_artefacto">Ayuda</a></li></ul></div>
