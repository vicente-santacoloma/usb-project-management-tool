...
%><html:html>
    <head>
        <title><bean:message key="VCrear_actividadParticipante.title"/></title>
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="title"><bean:message key="VCrear_actividadParticipante.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/APreBuscar_actividadParticipante.do"><bean:message key="VCrear_actividadParticipante.label1"/><%-- Buscar --%></html:link></li>
                    <li><html:link action="/APreListar_actividadParticipante.do"><bean:message key="VCrear_actividadParticipante.label2"/><%-- Listar --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1969788"><html:form
                  action="/ACrear_actividadParticipante.do" method="post">
                  ...
                  <html:submit styleClass="button"><bean:message key="VCrear_actividadParticipante.label0"/><%-- Crear --%></html:submit>
                </html:form></div>

                         </div>
                    </div>
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=VCrear_actividadParticipante">Ayuda</a></li></ul></div>
