...
%><html:html>
    <head>
        <title><bean:message key="V_rolActividad.title"/></title>
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="title"><bean:message key="V_rolActividad.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><script type="text/javascript">var _msg1 = "<bean:message key="V_rolActividad.cond1"/>";</script><html:link action="/AElim_rolActividad.do" paramId="idRolActividad" paramName="idRolActividad" onclick="if(!confirm(_msg1)) return false;"><bean:message key="V_rolActividad.label1"/><%-- Eliminar --%></html:link></li>
                    <li><html:link action="/APreCrear_rolActividad.do"><bean:message key="V_rolActividad.label2"/><%-- Agregar --%></html:link></li>
                    <li><html:link action="/APreListar_rolActividad.do"><bean:message key="V_rolActividad.label3"/><%-- Listar --%></html:link></li>
                    <li><html:link action="/APre_actividad.do" paramId="idActividad" paramName="idActividad"><bean:message key="V_rolActividad.label4"/><%-- Actividad --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1971012"><html:form
                  action="/AAct_rolActividad.do" method="post">
                  ...
                  <html:submit styleClass="button"><bean:message key="V_rolActividad.label0"/><%-- Actualizar --%></html:submit>
                </html:form></div>

                         </div>
                    </div>
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=V_rolActividad">Ayuda</a></li></ul></div>
