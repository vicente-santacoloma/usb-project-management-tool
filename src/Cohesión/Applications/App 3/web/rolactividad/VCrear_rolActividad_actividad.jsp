...
%><html:html>
    <head>
        <title><bean:message key="VCrear_rolActividad_actividad.title"/></title>
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="title"><bean:message key="VCrear_rolActividad_actividad.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/APre_actividad.do" paramId="idActividad" paramName="idActividad"><bean:message key="VCrear_rolActividad_actividad.label1"/><%-- Actividad --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1971012"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="VCrear_rolActividad_actividad.label0"/><%-- Crear --%></html:submit>
                </html:form></div>

                         </div>
                    </div>
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=VCrear_rolActividad_actividad">Ayuda</a></li></ul></div>
