...
%><html:html>
    <head>
        <title><bean:message key="VCrear_actividad_proyecto.title"/></title>
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="title"><bean:message key="VCrear_actividad_proyecto.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/APre_proyecto.do" paramId="idProyecto" paramName="idProyecto"><bean:message key="VCrear_actividad_proyecto.label1"/><%-- Proyecto --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1969518"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="VCrear_actividad_proyecto.label0"/><%-- Crear --%></html:submit>
                </html:form></div>

                         </div>
                    </div>
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=VCrear_actividad_proyecto">Ayuda</a></li></ul></div>
