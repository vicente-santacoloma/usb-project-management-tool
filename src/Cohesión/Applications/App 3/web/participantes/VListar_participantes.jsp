...
<ul>
  ...
  <table border="1">
      ...
      <tbody>
          <logic:iterate id="participantes" collection="${empty L_Participantes ? _vacio : L_Participantes}">
              <tr>
                  <td><html:link action="/APre_participantes.do" paramId="idParticipantes" paramName="participantes" paramProperty="idParticipantes">${empty participantes.nombre ? "Editar" : participantes.nombre}</html:link></td>
                  <td>${participantes.usuario}</td>
                  <td>${participantes.clave}</td>
