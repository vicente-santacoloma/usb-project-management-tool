...
public class Participante implements java.io.Serializable, ve.usb.cohesion.runtime.Auditable {

    /** Creates a new instance of Participante */
    public Participante() {}
    ...
    public String toString() {
        return "<Participante id='C" + this.id +
      //idParticipantes
      //roles
      "\" nombre =\"" + nombre +
      //proyectos
