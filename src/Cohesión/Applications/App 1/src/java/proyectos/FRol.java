...
public class FRol extends org.apache.struts.action.ActionForm {
    ...
    public static FRol clear(ActionMapping mapping, HttpServletRequest request) {
        HttpSession sess = request.getSession();
        FRol fFRol = (FRol) sess.getAttribute("FRol");
        if (fFRol == null) {
            fFRol = new FRol();
            sess.setAttribute("FRol", fFRol);
        } else {
            fFRol.reset(mapping, request);
        }
        return fFRol;
    }
