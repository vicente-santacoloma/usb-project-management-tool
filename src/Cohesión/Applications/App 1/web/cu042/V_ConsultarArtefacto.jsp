...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="32"><html:link action="/A_PreModificarArtefacto.do"><bean:message key="V_ConsultarArtefacto.label0"/><%-- Modificar Artefacto --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="32"><html:link action="/A_DescargarArtefacto.do"><bean:message key="V_ConsultarArtefacto.label2"/><%-- Descargar --%></html:link></cohesion:actor></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_ConsultarArtefacto.label1"/><%-- Busqueda --%></html:submit>
                </html:form></div>
