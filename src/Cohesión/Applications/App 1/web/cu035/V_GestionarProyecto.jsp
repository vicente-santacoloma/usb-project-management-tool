  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="16"><html:link action="/A_PreConsultarProyecto.do"><bean:message key="V_GestionarProyecto.label0"/><%-- Consultar Proyecto --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="16"><html:link action="/A_premodificarProyecto.do"><bean:message key="V_GestionarProyecto.label1"/><%-- Modificar --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="16"><html:link action="/A_PreInvitarUsuario.do"><bean:message key="V_GestionarProyecto.label2"/><%-- Invitar Usuario --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="16"><html:link action="/A_PreGestionarParticipante.do"><bean:message key="V_GestionarProyecto.label3"/><%-- Gestionar Participante --%></html:link></cohesion:actor></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_GestionarProyecto.label5"/><%-- Cerrar Sesion --%></html:link></li>
                    <li><html:link action="/A_PreCreacionActividad.do"><bean:message key="V_GestionarProyecto.label6"/><%-- Creacion Actividad --%></html:link></li>
                    <li><cohesion:actor actors="52"><html:link action="/A_PreGestionarActividades.do"><bean:message key="V_GestionarProyecto.label7"/><%-- Gestionar Actividades --%></html:link></cohesion:actor></li>
