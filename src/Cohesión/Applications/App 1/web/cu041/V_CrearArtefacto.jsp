...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_CrearArtefacto.label2"/><%-- Cerrar Sesion --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1970108"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_CrearArtefacto.label0"/><%-- A_CrearArtefacto --%></html:submit>
                </html:form></div>
