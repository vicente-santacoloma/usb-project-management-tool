...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_AgregarProcesoSoftware.label0"/><%-- A_CerrarSesion --%></html:link></li>
                    <li><cohesion:actor actors="8"><html:link action="/A_AgregarProcesoSoftware.do"><bean:message key="V_AgregarProcesoSoftware.label1"/><%-- A_AgregarProcesoSoftware --%></html:link></cohesion:actor></li>
