...
%><html:html>
    <head>
        <title><bean:message key="VCrear_rolParticipante_rol.title"/></title>
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="title"><bean:message key="VCrear_rolParticipante_rol.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/APre_rol.do" paramId="idRol" paramName="idRol"><bean:message key="VCrear_rolParticipante_rol.label1"/><%-- Rol --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1971136"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="VCrear_rolParticipante_rol.label0"/><%-- Crear --%></html:submit>
                </html:form></div>

                         </div>
                    </div>
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=VCrear_rolParticipante_rol">Ayuda</a></li></ul></div>
