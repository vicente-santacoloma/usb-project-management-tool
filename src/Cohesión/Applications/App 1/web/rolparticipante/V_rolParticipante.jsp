...
%><html:html>
    <head>
        <title><bean:message key="V_rolParticipante.title"/></title>
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="title"><bean:message key="V_rolParticipante.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><script type="text/javascript">var _msg1 = "<bean:message key="V_rolParticipante.cond1"/>";</script><html:link action="/AElim_rolParticipante.do" paramId="idRolParticipante" paramName="idRolParticipante" onclick="if(!confirm(_msg1)) return false;"><bean:message key="V_rolParticipante.label1"/><%-- Eliminar --%></html:link></li>
                    <li><html:link action="/APreCrear_rolParticipante_participantes.do" paramId="idParticipantes_super" paramName="idParticipantes_super"><bean:message key="V_rolParticipante.label2"/><%-- Agregar --%></html:link></li>
                    <li><html:link action="/APre_participantes.do" paramId="idParticipantes" paramName="idParticipantes"><bean:message key="V_rolParticipante.label3"/><%-- Participantes --%></html:link></li>
                    <li><html:link action="/APre_rol.do" paramId="idRol" paramName="idRol"><bean:message key="V_rolParticipante.label4"/><%-- Rol --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1971136"><html:form
                  action="/AAct_rolParticipante.do" method="post">
                  ...
                  <html:submit styleClass="button"><bean:message key="V_rolParticipante.label0"/><%-- Actualizar --%></html:submit>
                </html:form></div>

                         </div>
                    </div>
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=V_rolParticipante">Ayuda</a></li></ul></div>
