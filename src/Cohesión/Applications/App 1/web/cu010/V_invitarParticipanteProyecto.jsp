...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/A_PreConsultarPerfil.do"><bean:message key="V_invitarParticipanteProyecto.label0"/><%-- Consultar Perfil --%></html:link></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_invitarParticipanteProyecto.label2"/><%-- Cerrar Sesion --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_invitarParticipanteProyecto.label1"/><%-- Buscar --%></html:submit>
                </html:form></div>
