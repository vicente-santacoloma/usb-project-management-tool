...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="16"><html:link action="/A_AsignarSucesora.do"><bean:message key="V_AsignarSucesora.label0"/><%-- Asignar Sucesora --%></html:link></cohesion:actor></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_AsignarSucesora.label1"/><%-- Cerrar Sesion --%></html:link></li>
