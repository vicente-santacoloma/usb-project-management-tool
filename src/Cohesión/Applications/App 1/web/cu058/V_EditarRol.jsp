  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_EditarRol.label1"/><%-- A_CerrarSesion --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2021585"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_EditarRol.label0"/><%-- A_EditarRol --%></html:submit>
                </html:form></div>
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_EditarRol.label2"/><%-- A_PreBusqueda --%></html:submit>
                </html:form></div>
