...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="8"><html:link action="/A_ConsultarRol.do"><bean:message key="V_ConsultarRol.label0"/><%-- A_ConsultarRol --%></html:link></cohesion:actor></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_ConsultarRol.label2"/><%-- A_CerrarSesion --%></html:link></li>
