...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="8"><html:link action="/A_EliminarMetodologia.do"><bean:message key="V_EliminarMetodologia.label0"/><%-- A_EliminarMetodologia --%></html:link></cohesion:actor></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_EliminarMetodologia.label1"/><%-- A_CerrarSesion --%></html:link></li>
