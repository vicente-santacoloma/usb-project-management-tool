  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="52"><html:link action="/A_PreConsultaActividad.do"><bean:message key="V_ListarActividadesRol.label0"/><%-- Consulta Actividad --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="16"><html:link action="/A_PreListarRoles.do"><bean:message key="V_ListarActividadesRol.label1"/><%-- Listar Roles --%></html:link></cohesion:actor></li>
