...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="16"><html:link action="/A_PreConsultarProyecto.do"><bean:message key="V_MostrarGrafo.label0"/><%-- Consultar Proyecto --%></html:link></cohesion:actor></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_MostrarGrafo.label2"/><%-- Cerrar Sesion --%></html:link></li>
