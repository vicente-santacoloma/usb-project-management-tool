...
%><html:html>
    <head>
        <title><bean:message key="VCrear_proyecto_metodologia.title"/></title>
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="title"><bean:message key="VCrear_proyecto_metodologia.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/APre_metodologia.do" paramId="idMetodologia" paramName="idMetodologia"><bean:message key="VCrear_proyecto_metodologia.label1"/><%-- Metodologia --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1970636"><html:form
                  action="/ACrear_proyecto.do" method="post">
                  ...
                  <html:submit styleClass="button"><bean:message key="VCrear_proyecto_metodologia.label0"/><%-- Crear --%></html:submit>
                </html:form></div>

                         </div>
                    </div>
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=VCrear_proyecto_metodologia">Ayuda</a></li></ul></div>
