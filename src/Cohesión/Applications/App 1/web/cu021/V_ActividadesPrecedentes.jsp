...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="52"><html:link action="/A_PreConsultaActividad.do"><bean:message key="V_ActividadesPrecedentes.label0"/><%-- Consulta Actividad --%></html:link></cohesion:actor></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_ActividadesPrecedentes.label2"/><%-- Cerrar Sesion --%></html:link></li>
