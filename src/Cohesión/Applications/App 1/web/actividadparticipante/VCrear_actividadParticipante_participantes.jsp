...
%><html:html>
    <head>
        <title><bean:message key="VCrear_actividadParticipante_participantes.title"/></title>
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="title"><bean:message key="VCrear_actividadParticipante_participantes.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/APre_participantes.do" paramId="idParticipantes" paramName="idParticipantes"><bean:message key="VCrear_actividadParticipante_participantes.label1"/><%-- Participantes --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1969788"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="VCrear_actividadParticipante_participantes.label0"/><%-- Crear --%></html:submit>
                </html:form></div>

                         </div>
                    </div>
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=VCrear_actividadParticipante_participantes">Ayuda</a></li></ul></div>
