...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/A_PreProyectosParticipante.do"><bean:message key="V_ProyectosParticipante.label0"/><%-- Listar Proyectos Participante --%></html:link></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_ProyectosParticipante.label2"/><%-- Cerrar Sesion --%></html:link></li>
                    <li><cohesion:actor actors="16"><html:link action="/A_PreGestionarProyecto.do"><bean:message key="V_ProyectosParticipante.label3"/><%-- Gestionar Proyecto --%></html:link></cohesion:actor></li>
