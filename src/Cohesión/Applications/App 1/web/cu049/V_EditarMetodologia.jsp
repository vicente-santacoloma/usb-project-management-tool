...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="8"><html:link action="/A_AgregarProcesoSoftware.do"><bean:message key="V_EditarMetodologia.label1"/><%-- A_AgregarProcesoSoftware --%></html:link></cohesion:actor></li>
                    ...
                    <li><cohesion:actor actors="8"><html:link action="/A_EditarProcesoSoftware.do"><bean:message key="V_EditarMetodologia.label3"/><%-- A_EditarProcesoSoftware --%></html:link></cohesion:actor></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_EditarMetodologia.label4"/><%-- A_CerrarSesion --%></html:link></li>
