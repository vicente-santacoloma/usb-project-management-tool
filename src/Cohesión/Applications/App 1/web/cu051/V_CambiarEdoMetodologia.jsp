...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="4"><html:link action="/A_CambiarEdoMetologia.do"><bean:message key="V_CambiarEdoMetodologia.label0"/><%-- A_CambiarEdoMetologia --%></html:link></cohesion:actor></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_CambiarEdoMetodologia.label2"/><%-- A_CerrarSesion --%></html:link></li>
