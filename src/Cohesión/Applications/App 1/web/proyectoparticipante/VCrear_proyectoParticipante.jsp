...
%><html:html>
    <head>
        <title><bean:message key="VCrear_proyectoParticipante.title"/></title>
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="title"><bean:message key="VCrear_proyectoParticipante.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/APreBuscar_proyectoParticipante.do"><bean:message key="VCrear_proyectoParticipante.label1"/><%-- Buscar --%></html:link></li>
                    <li><html:link action="/APreListar_proyectoParticipante.do"><bean:message key="VCrear_proyectoParticipante.label2"/><%-- Listar --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1970747"><html:form
                  action="/ACrear_proyectoParticipante.do" method="post">
                  ...
                  <html:submit styleClass="button"><bean:message key="VCrear_proyectoParticipante.label0"/><%-- Crear --%></html:submit>
                </html:form></div>

                         </div>
                    </div>
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=VCrear_proyectoParticipante">Ayuda</a></li></ul></div>
