  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="8"><html:link action="/A_EliminarRol.do"><bean:message key="V_EliminarRol.label0"/><%-- Eliminar --%></html:link></cohesion:actor></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_EliminarRol.label1"/><%-- Cerrar Sesion --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box2023689"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_EliminarRol.label2"/><%-- Buscar --%></html:submit>
                </html:form></div>
