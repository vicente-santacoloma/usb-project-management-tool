...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="8"><html:link action="/A_PreEliminarMetodologia.do"><bean:message key="V_GestionarMetodologia.label0"/><%-- Eliminar Metodologia --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="8"><html:link action="/A_PreEditarMetodologia.do"><bean:message key="V_GestionarMetodologia.label1"/><%-- Editar Metodologia --%></html:link></cohesion:actor></li>
                    <li><cohesion:actor actors="68"><html:link action="/A_CargaMetodologia.do"><bean:message key="V_GestionarMetodologia.label3"/><%-- A_CargaMetodologia --%></html:link></cohesion:actor></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_GestionarMetodologia.label4"/><%-- A_CerrarSesion --%></html:link></li>
