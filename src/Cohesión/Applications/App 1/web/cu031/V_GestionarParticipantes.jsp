...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="16"><html:link action="/A_PreAsignarRol.do"><bean:message key="V_GestionarParticipantes.label0"/><%-- Asignar Rol --%></html:link></cohesion:actor></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_GestionarParticipantes.label2"/><%-- Cerrar Sesion --%></html:link></li>
