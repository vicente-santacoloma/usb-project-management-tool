...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="8"><html:link action="/A_AgregarRol.do"><bean:message key="V_AgregarRol.label0"/><%-- A_AgregarRol --%></html:link></cohesion:actor></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_AgregarRol.label1"/><%-- A_CerrarSesion --%></html:link></li>
