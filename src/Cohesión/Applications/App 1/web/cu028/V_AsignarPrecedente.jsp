...
%><html:html>
    ...
    <body>
        <div id="header">
            ...
            <div id="menu">
                <ul id="nav">
                    <li><cohesion:actor actors="16"><html:link action="/A_AsignarPrecedente.do"><bean:message key="V_AsignarPrecedente.label0"/><%-- Asignar Precedente --%></html:link></cohesion:actor></li>
                    <li><html:link action="/A_CerrarSesion.do"><bean:message key="V_AsignarPrecedente.label1"/><%-- Cerrar Sesion --%></html:link></li>
