...
%><html:html>
    <head>
        <title><bean:message key="VCrear_actividadPre.title"/></title>
  ...
  $( "#ayuda" )
    ...
    .click(function() {
      ...
      return false;
            ...
            <div id="title"><bean:message key="VCrear_actividadPre.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/APreListar_actividadPre.do"><bean:message key="VCrear_actividadPre.label1"/><%-- Listar --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1969984"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="VCrear_actividadPre.label0"/><%-- Crear --%></html:submit>
                </html:form></div>

                         </div>
                    </div>
                    <div id="right"><ul id="nav"><li><a id="ayuda" href="tooltip.do?V=VCrear_actividadPre">Ayuda</a></li></ul></div>
